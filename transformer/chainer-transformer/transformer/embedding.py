...
class SlrEmbedding(Chain):
    ...
    def __call__(self, x):
        ...
        #x = F.relu(self.fc1(x, n_batch_axes=2)) #jen relu zatim fungovalo nejlepe
        ...
        x = F.dropout(F.relu(self.fc1(x, n_batch_axes=2)), dropout_ppt) #linear projection jen, nic s timto moc nevychazelo
